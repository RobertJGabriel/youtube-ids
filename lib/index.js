...
function encode(_number) {
  ...
  if (_number >= Number.MAX_SAFE_INTEGER) {
    return 'Javascript can only handle 9007199254740991 or lower or 25 power of 3 are representable in the Number type';
  }
